// Package breakpoints provides primitives to interact with the openapi HTTP API.
//
...
// GenerateBreakPoint converts echo context to params.
func (w *ServerInterfaceWrapper) GenerateBreakPoint(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GenerateBreakPoint(ctx)
	return err
}
